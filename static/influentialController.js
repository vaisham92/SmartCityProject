wardroberapp.controller('influentialController', function ($scope, $http, $location) {
    ...
    // create a network
    var container = document.getElementById('influentialGraph');
    var data = {
        nodes: nodes,
        edges: edges
    };
